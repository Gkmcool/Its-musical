...
<body>
	<div id="site">
		...
		<div id="content">																																																																																																																																																																																																<div class="inner_copy"><a href="http://www.bestfreetemplates.info/builders.php">top 10 free website builders</a></div>
			<div id="wrapper">
				<div id="main">
					<div id="posts">
						<h2>Expedition Gallery</h2>
					  <div class="post">
							<h1 class="title">Ascent of Mount Everest</h1>
						...
						<div class="post">
							<h1 class="title">Tibet Travel</h1>
						...
						<div class="post">
							<h1 class="title">Near the Ocean</h1>
				...
				<div id="sidebar">
				<p align="Justify">	<h1><u><font face="Arial" size="5" color="#0033FF">If you are a registered user then please click on login otherwise please signup</font></u></h1>
				
				<ul></p>
				
								<li><font face="Times New Roman, Times, serif" size="5" color="#66FFFF"><a href="Login.jsp">Log IN</a></li></font>
								<li><font face="Times New Roman, Times, serif" size="5" color="#FF0066"><a href="signup.jsp">Sign Up</a></li></font>
		...
		<div id="footer">																																																																																																																																																																																																																												<div class="inner_copy"><a href="https://www.entrepreneur.com/article/276921">6 Top Professional Website Builders for Small Businesses</a></div>
			<div id="bottom_menu">
				<ul>
					<li><a href="#">Home</a></li>
					<li>|<a href="#">About me</a></li>
			...
			<div class="copyright">
				Copyright &copy; All rights reserved. Design by <a href="http://www.bestfreetemplates.info/" target="_blank">BFT</a>                                                                                                                                                                                                                                 
			</div>
		</div>
	</div>
</body>
